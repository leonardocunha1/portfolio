...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Redesign do site institucional da Sacada Premium, fabricante do sistema Skyline® de envidraçamento de sacadas sem roldanas. Hero cósmico em parallax, animações ligadas ao scroll (incluindo um sistema de vidro que recolhe folha a folha), menu mobile full-screen animado e fotos do produto em galeria. SEO técnico com JSON-LD, sitemap e Open Graph, captura de leads via WhatsApp e estética premium inspirada em referências como Lumon, Solarlux e Linear.",
    stack: [
      "Next.js 16",
      "React 19",
      "TypeScript",
    ...
    gallery: [
      ...
      "/sacada-premium/diferenciais.png",
      "/sacada-premium/projetos.png",
      "/sacada-premium/hero-mobile.png",
      "/sacada-premium/menu-mobile.png",
    ],
  },
  {
